...
const HeroSection = () => {
    ...
    return (
        <div className="relative bg-gradient-to-b from-blue-50 to-indigo-50 overflow-hidden">
            {/* Main Content */}
            <div className="relative z-10 container mx-auto px-8 py-16 flex flex-col lg:flex-col items-center">
                {/* Image Content */}
                <div className="w-full mb-12 lg:pr-12">
            ...
            <div className="absolute bottom-0 left-0 right-0 overflow-hidden">
                ...
                <svg viewBox="0 0 1200 120" preserveAspectRatio="none" className="w-full h-16 mt-0">
