...
const MeetingManagement = () => {
    ...
    const handleCreateMeeting = async (e) => {
        ...
        try {
            setLoading(true);
            const response = await fetch(`${import.meta.env.VITE_API_URL}/api/meeting/create`, {
                method: 'POST',
    ...
    const handleUpdateMeeting = async (e) => {
        ...
        try {
            setLoading(true);
            const response = await fetch(`${import.meta.env.VITE_API_URL}/api/meeting/update/${editingMeeting._id}`, {
                method: 'PUT',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify(formData)
            });
    ...
    const handleFileUpload = async (meetingId, files) => {
        try {
            ...
            const response = await fetch(`${import.meta.env.VITE_API_URL}/api/meeting/upload/${meetingId}`, {
                method: 'PUT',
                body: formData
            });
    ...
    const handleDeleteDocument = async (meetingId, fileUrl) => {
        try {
            const response = await fetch(`${import.meta.env.VITE_API_URL}/api/meeting/delete-pdf/${meetingId}`, {
                method: 'PUT',
                headers: { 'Content-Type': 'application/json' },
